...
Source0  : https://www.x.org/releases/individual/app/xdpyinfo-1.3.3.tar.gz
Source1  : https://www.x.org/releases/individual/app/xdpyinfo-1.3.3.tar.gz.sig
...
%prep
%setup -q -n xdpyinfo-1.3.3
cd %{_builddir}/xdpyinfo-1.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649373836
...
cp %{_builddir}/xdpyinfo-1.3.3/COPYING %{buildroot}/usr/share/package-licenses/xdpyinfo/a7c968e282631e3b29c66bcf4a438fc72b68be27
%make_install
